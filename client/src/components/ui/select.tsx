import { Root, Group, Value, Trigger, Icon, Portal, Content, Viewport, Label, Item, ItemIndicator, ItemText, Separator, ScrollUpButton, ScrollDownButton } from '@radix-ui/react-select';
